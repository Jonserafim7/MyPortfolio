        ...
        return (
            ...
            >
                ...
                <div className="title-container relative z-30 col-start-2 row-start-1 flex h-max flex-col justify-self-end overflow-hidden">
                    <h3 className="title font-mont text-3xl font-black uppercase drop-shadow">
                        {project.title}
                    </h3>
                ...
                <div className="relative z-30 col-start-1 row-start-2 flex flex-col self-end justify-self-start">
                    ...
                    <h5 className="text-2xl font-medium text-teal-400">
                        {project.scope}
                    </h5>
                ...
                <div className="buttons-container z-30 col-start-2 row-start-2 flex self-end justify-self-end">
                    <ButtonWithIcon variant={'ghost'} size="sm" className="">
                        <svg
                            width="30"
                            height="30"
                            viewBox="0 0 60 60"
                ...
                <div className="card-overlay bg-gradient-radial absolute z-20 h-full w-full filter"></div>
                <div className="card-bg absolute inset-0 left-[-25%] top-[-25%] z-10 h-[150%] w-[150%] bg-[url('/imgs/vanlife.png')] bg-cover bg-center bg-no-repeat"></div>
            </div>
        )
    }
)
