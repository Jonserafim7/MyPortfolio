export default function Nav() {
  return (
    <header className="sticky top-2 z-50 flex w-full">
      <nav className="elevation-5 flex h-16 w-full items-center justify-between rounded-3xl border border-neutral-800 p-10 before:absolute overflow-hidden before:backdrop-blur relative before:-z-10 before:inset-0">
        {/* LOGO */}
        <div className="elevation-5 bg-teal-500 font-space text-2xl font-bold py-2 px-5 rounded-xl">
          J
        </div>

        {/* nav links for lg screen sizes*/}
        <ul className="items-center flex justify-center gap-20">
          <li>
            <a href="#">Contact</a>
          </li>
          <li>
